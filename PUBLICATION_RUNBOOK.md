...
5. Promote `CONTRIBUTING_DRAFT.md` and `SECURITY_DRAFT.md` only after owner-specific values replace draft placeholders.
...
- `CONTRIBUTING_DRAFT.md` and `SECURITY_DRAFT.md` remain draft files in this monorepo shelf
